...
- June 27, 2025: Implemented swipe-to-delete functionality for chat messages - added touch and mouse swipe gesture detection for sent messages, users can swipe messages right to reveal delete confirmation with "Delete" and "Cancel" buttons, includes visual feedback with trash icon during swipe, smooth animations with CSS transforms, proper event handling for both touch and mouse interactions, and automatic reset if swipe distance is insufficient
