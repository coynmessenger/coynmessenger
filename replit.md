...
- June 26, 2025: Updated wallet connection display names - replaced "Trust Wallet User", "WalletConnect User", and "Coinbase User" with "You" for consistent user identification across all wallet connection methods
