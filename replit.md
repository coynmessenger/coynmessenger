...
- June 27, 2025: Enhanced Details dropdown with creative floating info button design - replaced text button with glassmorphism floating info icon in top-right corner of product cards, added animated pulse ring effects, hover tooltips with dynamic text, enhanced collapsible section with gradient backgrounds, colorful info cards with gradient icons, creative product description styling with accent border, enhanced crypto conversion section with decorative backgrounds, improved "Explore Full Product Details" button with gradient styling and hover animations
...
- June 27, 2025: Added double-tap screenshot functionality to marketplace page - implemented double-tap detection for both touch and mouse events, users can double-tap anywhere on marketplace to capture and download a screenshot using html2canvas library, includes toast notifications for success/error feedback
