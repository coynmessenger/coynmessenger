...
- June 26, 2025: Redesigned messenger to unified single-page layout - all sidebar content (conversations, wallet, search) now displays directly on main page eliminating separate sidebar navigation, applied to both desktop and mobile for consistent user experience
