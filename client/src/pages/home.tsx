                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex justify-center mobile-wallet-connector">
                      <ThirdwebWalletConnector
                        ...
                        className="w-full min-h-[56px] bg-gray-400 dark:bg-gray-600 hover:bg-gray-500 dark:hover:bg-gray-500 active:bg-gray-600 dark:active:bg-gray-400 text-white font-medium py-4 px-6 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg border border-gray-500 dark:border-gray-500 touch-manipulation select-none"
                      />
                    </div>
