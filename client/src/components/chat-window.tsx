  ...
  return (
    <div className="flex flex-col h-full bg-background chat-container">
      ...
      <div className="border-t border-gray-200/60 dark:border-slate-700/40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl px-3 py-2.5 sm:px-4 sm:py-3 shadow-lg shrink-0 mt-auto">
        ...
        <form onSubmit={handleSendMessage} className="chat-input-form flex items-center gap-0.5 bg-gray-100/80 dark:bg-slate-800/80 rounded-2xl border border-gray-200/60 dark:border-slate-600/40 px-1 py-1 shadow-inner backdrop-blur-sm">
