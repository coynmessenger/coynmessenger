...
export default function WalletSidebar({ isOpen, onClose, user }: WalletSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className="anim-wallet-panel fixed right-0 top-0 h-full w-80 bg-white/95 dark:bg-slate-900/95 backdrop-blur-2xl border-l border-white/30 dark:border-slate-700/50 z-50 shadow-2xl hover:shadow-orange-200/20 dark:hover:shadow-orange-900/20 transition-shadow duration-500 overflow-hidden">
